...
public class Examples
{
    ...
    RugbyTeam JA = new RugbyTeam("JA", "WHITE", false, 100, 1);
    RugbyTeam BR = new RugbyTeam("BR", "WHITE", false, 101, 1);

    // matches

    Match USvCA = new Match (US, CA, new RugbyResult(10,0));
    Match AvEN = new Match (A, EN, new RugbyResult(10,0));
    Match USvA = new Match (US, A, new RugbyResult(10,0));
    Match EnvJA = new Match (EN, JA, new RugbyResult(10,0));
    Match AvBR = new Match (A, BR, new RugbyResult(10,0));
    ...
    public boolean testCountUnderdogWonBroken(Tester   t)
    {
    ...
    Match RvM = new Match (RPI, MIT, RPIvsMIT);
    Match MvB = new Match(MIT, BEK, MITvsBEK);
    Match RvU = new Match(RPI, UMASS, RPIvsUMASS);
