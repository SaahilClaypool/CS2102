 ...
 */
// Class to represent the result of contestant1 robotics match
public class RoboticsResult implements IResult
{
    // robotics result is the points and taakss of each robot and contestant1 boolean for if each team fell
    ...
    {
        // A score is the sum of the points and tasks, and contestant1 five point penalty if the team falls
